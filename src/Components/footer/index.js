...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-gray-800 via-gray-700 to-gray-800 text-white py-6">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="flex flex-col justify-center md:justify-start">
          <p className="mb-4">&copy; {new Date().getFullYear()} Hackon Team Dynamo from NIT Jalandhar. All rights reserved.</p>
